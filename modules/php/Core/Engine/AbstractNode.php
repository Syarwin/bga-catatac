...
class AbstractNode
{
  ...
  public function insertAsBrother($newNode)
  {
    ...
    if (!$this->parent instanceof \Bga\Games\Catatac\Core\Engine\SeqNode) {
      $newParent = new \Bga\Games\Catatac\Core\Engine\SeqNode([], []);
  ...
  public function choose($childIndex, $auto = false)
  {
    ...
    if (!$auto && !($child instanceof \Bga\Games\Catatac\Core\Engine\LeafNode)) {
