...
!(function (t) {
  ...
  (i.prototype.getDistance = function (t) {
    ...
    for (e = 0; e < this.xNumSteps.length - 1; e++) {
      ...
      if (n && (t / n) % 1 != 0)
        throw new Error(
          'noUiSlider (' + lt + "): 'limit', 'margin' and 'padding' of " + this.xPct[e] + '% range must be divisible by step.'
        );
      r[e] = p(this.xVal, t, e);
    }
    return r;
  ...
  function j(t, b, o) {
    ...
    function _(t, e) {
      e.handle && (mt(e.handle, b.cssClasses.active), (g -= 1)),
        ...
        0 === g &&
          (mt(h, b.cssClasses.drag), et(), t.cursor && ((C.style.cursor = ''), C.removeEventListener('selectstart', ct))),
